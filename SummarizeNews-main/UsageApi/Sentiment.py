...
class Sentiment(metaclass=Singleton):
    def __init__(self):
        pass

    def process(self,text):
        url = config.SENTIMENT
        new_ver = Verify()
        new_ver.text = text
