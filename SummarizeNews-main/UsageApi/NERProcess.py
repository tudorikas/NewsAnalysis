...
class NerProcess(metaclass=Singleton):
    def __init__(self):
        pass
    ...
    def process(self,text):
        ...
        r = requests.get(url, data=ver_json, headers=headers, timeout=700, files=files)
